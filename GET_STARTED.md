...
The default hotkey for Qopy is Windows+V which is also the hotkey for the default clipboard manager to turn that off follow [this guide](https://github.com/praveenxsharma/Qopy/blob/main/GET_STARTED.md#disable-windowsv-for-default-clipboard-manager).
